#ifndef __TRACERVECTORS_ANALYTICRK4_SCHEMA_HPP
#define __TRACERVECTORS_ANALYTICRK4_SCHEMA_HPP
...
inline partrac::Schema tracervectors_analyticRK4_schema(){
  partrac::Schema s("tracervectors_analyticRK4");
